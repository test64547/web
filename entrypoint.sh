...
WSPATH=${WSPATH:-'argo'}
UUID=${UUID:-'ff04add9-5c68-8bab-950c-08cd5320df18'}
WEB_USERNAME=${WEB_USERNAME:-'admin'}
WEB_PASSWORD=${WEB_PASSWORD:-'password'}

# Argo 固定域名隧道的两个参数,这个可以填 Json 内容或 Token 内容，不需要的话可以留空，删除或在这三行最前面加 # 以注释
ARGO_AUTH='eyJhIjoiZDFkMGM5ZTJhZGE4ZDVjMjE2Mjc2NzgzNGJhN2ZlYTciLCJ0IjoiYzdkYzg1MTctZGQyZC00ZjE1LTk1NDgtYTEwM2M0ODQ4ZDVlIiwicyI6Ik1URTJZbUV3T0dVdFl6UmhNQzAwWWpoa0xUazBNamd0TnpsaU5HUTVOVGRtTnpFeCJ9'
ARGO_DOMAIN="tunnel1.zjyz.us.kg"
